...
add_action( 'rest_api_init', function () {
  ...
  register_rest_route( 'schoolistit/v2', '/text-to-speech', array(
    'methods' => 'GET, POST',
    'callback' => __NAMESPACE__.'\\text_to_speech',
  ) );
...
function text_to_speech(\WP_REST_Request $request){
  /*
  $apikey = 'siXsu3GSNkP1M9iRcTvh3lyCbv1TabiYkiyp9Gfb0suN';
  $url = 'https://api.us-east.text-to-speech.watson.cloud.ibm.com/instances/b85a3a3c-d142-4eed-bded-bd86bcd5bd4c/v1/synthesize';
  $headers = array(
    'apikey' => $apikey,
...
curl_setopt($ch, CURLOPT_URL, 'https://api.us-east.text-to-speech.watson.cloud.ibm.com/instances/b85a3a3c-d142-4eed-bded-bd86bcd5bd4c/v1/synthesize');
curl_setopt($ch, CURLOPT_RETURNTRANSFER, 1);
curl_setopt($ch, CURLOPT_POST, 1);
curl_setopt($ch, CURLOPT_POSTFIELDS, "{\"text\":\"hello world\"}");
curl_setopt($ch, CURLOPT_USERPWD, 'apikey' . ':' . 'siXsu3GSNkP1M9iRcTvh3lyCbv1TabiYkiyp9Gfb0suN');
